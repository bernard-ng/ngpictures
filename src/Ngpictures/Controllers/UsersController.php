...
class UsersController extends Controller
{
    ...
    ****************************************************************************/
    ...
    public function reset($id, string $token)
    {
        ...
        if ($user && $user->reset_token == $token) {
            ...
            $this->pageManager::setName("Rénitialisation du mot de passe | Ngpictures");
    ...
    public function forgot()
    {
        ...
        $this->pageManager::setName('Mot de passe oublié | Ngpictures');
        $this->setLayout('users/default');
    ...
    public function sign()
    {
        ...
        $this->pageManager::setName("Inscription | Ngpictures");
        $this->setLayout('users/default');
    ...
    ****************************************************************************/
    ...
    public function login()
    {
        ...
        if ($this->isLogged()) {
            ...
            $this->pageManager::setName('Connexion | Ngpictures');
            $this->setLayout('users/default');
    ...
    ****************************************************************************/
    ...
    public function account($username, $id)
    {
        if (!empty($username) && !empty($id)) {
            ...
            if ($user && $this->str::checkUserUrl($username, $user->name) == true) {
                ...
                $this->pageManager::setName($user->name . " | Ngpictures");
    ...
    public function edit(string $username, $id, string $token)
    {
        if ($token === $this->session->read(TOKEN_KEY)) {
            ...
            if ($user && $this->str::checkUserUrl($username, $user->name) == true) {
                ...
                $this->pageManager::setName('Edition du profile | Ngpictures');
    ...
    public function post()
    {
        ...
        $this->pageManager::setName("Publier un article | Ngpictures");
