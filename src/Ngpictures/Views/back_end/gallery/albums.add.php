<section class="section container row">
    <section class="col l9 m12 s12">
        <h2 class="ui header">Ajouter un album<i class="icon icon-pencil right"></i></h2>
        <form action="" method="POST" class="card-panel grey dark-4">
            ...
            <div class="col l12 m12 s12">
                <div class="input-field">
                    ...
                    <textarea id="contents" name="description" class="materialize-textarea"><?= $post->get('description') ?></textarea>
                </div>
            </div>
