    ...
    <div class="col l8 jumbotron dark">
        <form action="">
            <div class="input-field">
                ...
                <textarea name="msg" id="msg" class="mdz-textarea"></textarea>
            </div>
        </form>
    </div>
   <div class="col l4">
...
<script>(function(d, s, id) {
        ...
        js.src = 'https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v3.0&appId=518552818524133&autoLogAppEvents=1';
