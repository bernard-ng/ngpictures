...
class Pages {
	...
	private static $names = [
		...
		"galerie" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
					quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
					consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
					cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
	...
	public static function getDescription(string $page): string
	{
		$pages = new Collection(self::$names);
		return $pages->get(strtolower($page));
	}

	public static function getIcon(string $page): string
	{
		$icons = new Collection(self::$icons);
		return $icons->get(strtolower($page));
	}
}
