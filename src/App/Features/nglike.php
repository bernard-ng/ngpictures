			...
			if(isset($_GET['t'],$_GET['id']) AND !empty($_GET['t']) AND !empty($_GET['id']))
			{
				...
				if($verif->rowcount() == 1)
				{
					if($_GET['t'] == 1)
					{
						...
						echo KM_format(ngarticle_info($getID,"like"));
					...
					elseif($_GET['t'] == 2)
					{
						...
						echo KM_format(ngarticle_info($getID,"dislike"));
					...
					elseif($_GET['t'] == 3)
					{
						...
						echo KM_format(ngarticle_info($getID,"love"));
						
						
					}else{  header('500 internal server error' , true, 500) ;}
			...
			if(isset($_GET['t'],$_GET['id']) AND !empty($_GET['t']) AND !empty($_GET['id']))
			{
				...
				if($verif->rowcount() == 1)
				{
					if($_GET['t'] == 1)
					{
						...
						echo KM_format(article_info($getID,"like"));
					...
					elseif($_GET['t'] == 2)
					{
						...
						echo KM_format(article_info($getID,"dislike"));
					...
					elseif($_GET['t'] == 3)
					{
						...
						echo KM_format(article_info($getID,"love"));
			...
			if(isset($_GET['t'],$_GET['id']) AND !empty($_GET['t']) AND !empty($_GET['id']))
			{
				...
				if($verif->rowcount() == 1)
				{
					if($_GET['t'] == 1)
					{
						...
						echo KM_format(photo_info($getID,"like"));
					...
					elseif($_GET['t'] == 2)
					{
						...
						echo KM_format(photo_info($getID,"dislike"));
					...
					elseif($_GET['t'] == 3)
					{
						...
						echo KM_format(photo_info($getID,"love"));
			...
			if(isset($_GET['t'],$_GET['id']) AND !empty($_GET['t']) AND !empty($_GET['id']))
			{
				...
				if($verif->rowcount() == 1)
				{
					if($_GET['t'] == 1)
					{
						...
						echo KM_format(ngphoto_info($getID,"like"));
					...
					elseif($_GET['t'] == 2)
					{
						...
						echo KM_format(ngphoto_info($getID,"dislike"));
					...
					elseif($_GET['t'] == 3)
					{
						...
						echo KM_format(ngphoto_info($getID,"love"));
