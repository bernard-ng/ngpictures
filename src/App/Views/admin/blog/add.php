        ...
        <div class="card">
            ...
            <form action="#" method="POST" class="ml-10 mr-10 mb-30" enctype="multipart/form-data">
                ...
                <div class="col l6 m6 s12">
                    <input type="text" id="title" name="title" placeholder="titre" value="<?= $post->getWhenSet('title') ?>" required>
                </div>

                <div class="col l6 m6 s12">
                    <input type="text" id="slug" name="slug" placeholder="slug" value="<?= $post->getWhenSet('slug') ?>" required>
                </div>
