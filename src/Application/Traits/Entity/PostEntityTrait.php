...
trait PostEntityTrait
{
    ...
    {
        $category = Application::getDic()->get(StringManager::class)->slugify($this->category);
    ...
    {
        $saves = Application::getDic()->get($this->model('saves'));
    ...
    {
        $str = Application::getDic()->get(StringManager::class);
        $users = Application::getDic()->get($this->model('users'));
