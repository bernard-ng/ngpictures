...
class MessageManager implements ArrayAccess
{
    ...
    private $messages = [
        ...
        "form_photographers_submitted"  =>  "Bravo, vous faites partie de la grande famille des photographes, un mail vous a été envoyer___",
        ...
        "users_username_used"       => "Ce pseudo est déjà utilisé par un autre compte",
        "users_email_used"          => "Cette adresse mail est déjà utilisée par un autre compte",
