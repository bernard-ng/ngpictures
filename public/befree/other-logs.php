...
if (isset($_GET['delete-all'])) {
    $table = $prefix . 'logs';
    $query = $mysqli->query("DELETE FROM `$table` WHERE type='Bad Bot' or type='Fake Bot' or type='Missing User-Agent header' or type='TOR Detected' or type='Invalid IP Address header'");
}
?>
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-dark"><i class="fas fa-align-justify"></i> Other Logs</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Other Logs</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
				...
				<div class="col-md-12">
				    ...
				    <div class="card">
						<div class="card-header">
							<h3 class="card-title">Other Logs</h3>
						</div>
						<div class="card-body">
...
<?php
$table = $prefix . 'logs';
$sql   = $mysqli->query("SELECT id, ip, date, browser, browser_code, os, os_code, country, country_code, type FROM `$table` WHERE type='Bad Bot' or type='Fake Bot' or type='Missing User-Agent header' or type='Missing header Accept' or type='TOR Detected' or type='Invalid IP Address header' ORDER by id DESC");
